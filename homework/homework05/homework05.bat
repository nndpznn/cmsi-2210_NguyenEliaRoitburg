...
REM dec2hex                             >> testresults.txt
REM dec2hex 5                           >> testresults.txt
REM dec2hex 123456 32                   >> testresults.txt
REM dec2hex 65535                       >> testresults.txt
REM dec2hex 977272832 32                >> testresults.txt
REM dec2hex 1073746484                  >> testresults.txt
REM dec2hex 5 64                        >> testresults.txt
REM dec2hex 123456 64                   >> testresults.txt
REM dec2hex 65535 63                    >> testresults.txt
REM dec2hex 977272832 64                >> testresults.txt
REM dec2hex 1073746484                  >> testresults.txt
echo . >> testresults.txt
